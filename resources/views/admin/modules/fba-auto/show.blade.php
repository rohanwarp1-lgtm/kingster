                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h4 class="card-title mb-0">Products ({{ $items->count() }})</h4>
                            @php $totalQty = $items->sum('qty'); $totalPrice = $items->sum('qty_price'); @endphp
                            <span class="text-muted small">
                                Total Qty: <strong>{{ number_format($totalQty) }}</strong>
                                &nbsp;|&nbsp;
                                Total: <strong>₹{{ number_format($totalPrice, 2) }}</strong>
                            </span>
                        </div>
                                ...
                                <table class="table table-bordered table-sm align-middle mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><strong>{{ number_format($item->qty) }}</strong></td>
