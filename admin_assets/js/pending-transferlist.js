var jsonDataUrl = '../admin_assets/json/pending-transferlist.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#pending-transferlist-data')) {
            $('#pending-transferlist-data').DataTable().destroy();
        }
        var table = $('#pending-transferlist-data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: '#' },
