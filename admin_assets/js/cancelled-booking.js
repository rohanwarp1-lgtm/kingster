var jsonDataUrl = '../admin_assets/json/cancelled-booking.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#cancelled-booking-data')) {
            $('#cancelled-booking-data').DataTable().destroy();
        }
        var table = $('#cancelled-booking-data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: '#' },
