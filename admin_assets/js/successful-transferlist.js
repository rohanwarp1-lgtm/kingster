var jsonDataUrl = '../admin_assets/json/successful-transferlist.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#successful-transferlist-data')) {
            $('#successful-transferlist-data').DataTable().destroy();
        }
        var table = $('#successful-transferlist-data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: '#' },
