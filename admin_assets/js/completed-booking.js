var jsonDataUrl = '../admin_assets/json/completed-booking.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#completed-booking-data')) {
            $('#completed-booking-data').DataTable().destroy();
        }
        var table = $('#completed-booking-data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: '#' },
