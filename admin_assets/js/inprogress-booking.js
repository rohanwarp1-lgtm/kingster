var jsonDataUrl = '../admin_assets/json/inprogress-booking.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#inprogress-booking-data')) {
            $('#inprogress-booking-data').DataTable().destroy();
        }
        var table = $('#inprogress-booking-data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: '#' },
