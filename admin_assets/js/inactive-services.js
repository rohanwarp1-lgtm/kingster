var jsonDataUrl = '../admin_assets/json/inactive-services.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#inactive-services-data')) {
            $('#inactive-services-data').DataTable().destroy();
        }
        var table = $('#inactive-services-data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: '#' },
