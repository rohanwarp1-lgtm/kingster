var jsonDataUrl = '../admin_assets/json/customers.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#customers-data')) {
            $('#customers-data').DataTable().destroy();
        }
        var table = $('#customers-data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: '#' },
