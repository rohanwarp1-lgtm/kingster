var jsonDataUrl = '../admin_assets/json/rejected-transferlist.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#rejected-transferlist-data')) {
            $('#rejected-transferlist-data').DataTable().destroy();
        }
        var table = $('#rejected-transferlist-data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: '#' },
