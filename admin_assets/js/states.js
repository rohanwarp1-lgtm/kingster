var jsonDataUrl = '../admin_assets/json/states.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#states-data')) {
            $('#states-data').DataTable().destroy();
        }
                ...
                { data: 'StateName' },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="table-actions d-flex">
                                                <button class="btn delete-table me-2" type="button" data-bs-toggle="modal" data-bs-target="#edit-state">
                                                   <i class="fe fe-edit"></i>
                                                </button>
                                                <button class="btn delete-table" type="button" data-bs-toggle="modal" data-bs-target="#delete-state">
