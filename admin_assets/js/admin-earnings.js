var jsonDataUrl = '../admin_assets/json/admin-earnings.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#admin-earnings-data')) {
            $('#admin-earnings-data').DataTable().destroy();
        }
        var table = $('#admin-earnings-data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: '#' },
