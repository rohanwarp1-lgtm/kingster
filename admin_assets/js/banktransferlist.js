var jsonDataUrl = '../admin_assets/json/banktransferlist.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#banktransferlist-data')) {
            $('#banktransferlist-data').DataTable().destroy();
        }
        var table = $('#banktransferlist-data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: '#' },
