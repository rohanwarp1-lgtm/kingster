var jsonDataUrl = '../admin_assets/json/pending-services.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#pending-services-data')) {
            $('#pending-services-data').DataTable().destroy();
        }
        var table = $('#pending-services-data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: '#' },
